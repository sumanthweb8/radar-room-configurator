...
import type { Room } from '../houseModel';
...
interface Props {
  ...
  onRoomFieldChange?: (field: 'name' | 'board' | 'location', value: string) => void;
}
  ...
  if (!object) {
    return (
      <aside style={{ width: 240, background: bg, borderLeft: `1px solid ${border}`, flexShrink: 0, display: 'flex', flexDirection: 'column' }}>
        {activeRoom && onRoomFieldChange && (
          <div style={{ padding: '14px 16px', borderBottom: `1px solid ${border}` }}>
            <p style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: textSm, marginBottom: 10 }}>Room settings</p>
            <label style={{ display: 'block', fontSize: 10, color: textSm, marginBottom: 4 }}>Name</label>
            <input type="text" value={activeRoom.name} placeholder="Room 1"
              onChange={e => onRoomFieldChange('name', e.target.value)}
              style={{ width: '100%', background: inputBg, border: `1px solid ${inputBorder}`, borderRadius: 8, padding: '6px 10px', fontSize: 12, color: textMd, outline: 'none', marginBottom: 10, boxSizing: 'border-box', fontFamily: 'inherit' }}
            />
            <label style={{ display: 'block', fontSize: 10, color: textSm, marginBottom: 4 }}>Board ID</label>
            <input type="text" value={activeRoom.board} placeholder="kc2508p012"
              onChange={e => onRoomFieldChange('board', e.target.value)}
              style={{ width: '100%', background: inputBg, border: `1px solid ${inputBorder}`, borderRadius: 8, padding: '6px 10px', fontSize: 12, color: textMd, outline: 'none', marginBottom: 10, boxSizing: 'border-box', fontFamily: 'monospace' }}
            />
            <label style={{ display: 'block', fontSize: 10, color: textSm, marginBottom: 4 }}>Location label</label>
            <input type="text" value={activeRoom.location} placeholder="room1"
              onChange={e => onRoomFieldChange('location', e.target.value)}
              style={{ width: '100%', background: inputBg, border: `1px solid ${inputBorder}`, borderRadius: 8, padding: '6px 10px', fontSize: 12, color: textMd, outline: 'none', boxSizing: 'border-box', fontFamily: 'monospace' }}
            />
          </div>
        )}
